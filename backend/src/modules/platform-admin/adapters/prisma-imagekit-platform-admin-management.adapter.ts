...
@Injectable()
export class PrismaImageKitPlatformAdminManagementAdapter implements PlatformAdminManagementPort {
  constructor(
  ...
  private readonly logger = new Logger(PrismaImageKitPlatformAdminManagementAdapter.name);
  ...
  async createBrand(data: PlatformCreateBrandInput) {
  ...
  async updateBrand(id: string, data: PlatformUpdateBrandInput) {
    try {
  ...
  async createLocation(brandId: string, data: PlatformCreateLocationInput) {
  ...
  async updateLocation(id: string, data: PlatformUpdateLocationInput) {
    try {
  ...
  async assignBrandAdmin(brandId: string, data: PlatformAssignBrandAdminInput) {
  ...
  async removeBrandAdmin(brandId: string, data: PlatformRemoveBrandAdminInput) {

...
} from '../../../contexts/commerce/domain/services/coupon-discount-policy';
import { PrismaService } from '../../../prisma/prisma.service';

const DEFAULT_TX_LIMIT = 12;

@Injectable()
export class PrismaSubscriptionReferralRewardManagementAdapter implements EngagementReferralRewardManagementPort {
  constructor(
  ...
  calculateCouponDiscount(params: { couponType: RewardType; couponValue: number | null; baseServicePrice: number }) {
    return calculateCouponDiscount({
      couponType: params.couponType as CouponDiscountType,
